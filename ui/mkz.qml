...
//                 property var fillExtrusionHeight: { return { type: "identity", property: "height" } }
                property var fillExtrusionHeight: { return { property: "height", type: "interpolate", ["linear"], ["zoom"], { addArgument: "stops", { addArgument: [15, 0, 15.05, { return { type: "get", property: "height"} } ] } } } }
