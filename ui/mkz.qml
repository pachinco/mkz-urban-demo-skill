...
//             width: parent.width*0.7
            ...
            path: Path {
                ...
                PathQuad { x: actionsView.width*0.5; y: actionsView.height*0.2; controlX: actionsView.width*1.2; controlY: actionsView.height*0.5 }
                PathAttribute { name: "iconScale"; value: 0.3 }
                PathAttribute { name: "iconOpacity"; value: 0.5 }
                PathQuad { x: actionsView.width*0.5; y: actionsView.height*0.6; controlX: actionsView.width*-0.2; controlY: actionsView.height*0.5 }
            }
//             cellWidth: width/3
//             cellHeight: height
//             move: Transition {
